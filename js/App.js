...
(function (global, factory) {
    ...
    window.onload = function () {
        ...
        htmlFile.onclick = function(){
            ...
            cssContent.style = "width:0px;height:0px;overflow:hidden";
            editorFocus();
            state = "html";
        ...
        cssFile.onclick = function(){
            ...
            htmlContent.style = "width:0px;height:0px;overflow:hidden";
            editorFocusCSS();
            state = "css";
        }
        ...
        var val = "";
        var inTag = false;
        var codeContent = editor.getElementById('codeContent');
        ...
        var classname = "";
        var currTopSuggestion = 0;
        var enterSuggestion = false;
        ...
        function getCaret() {
            ...
            var line = nd.parentElement.getAttribute('data-value');
            ...
            editor.getElementById('status').innerHTML = 'Ln ' + line + ', Col ' + col + '&nbsp;&nbsp;&nbsp;&nbsp;Spaces: ' + tabSize;
            updateLine();
